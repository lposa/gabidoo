    ...
    <>
      <div className="footer-container">
        <div className="footer-container-item" id="footer-item-border">
          ...
          <div className="footer-icon-container">
            <i className="fas fa-envelope"> </i> <p> info @gabi - boje.rs </p>
          </div>
          <div className="footer-icon-container">
            <i className="fas fa-mobile-alt"> </i> <p> +381(0) 23 527 184 </p>
          </div>
          <div className="footer-icon-container">
        ...
        >
          <h3> Informacije </h3> <a> O nama </a> <a> Gde se nalazimo </a>
          <a> Politika privatnosti </a> <a> Ugovor o kupovini </a>
          <a> Najcesca pitanja </a> <a> Uslovi koriscenja </a>
          <i
        ...
        <div className="footer-container-item footer-item-text">
          <h3> Kupovina </h3> <a> Pracenje porudzbine </a> <a> Dostava robe </a>
          <a> Kako poruciti </a> <a> Reklamacije </a> <a> Nacini placanja </a>
